      ...
      <div class="space-y-3" v-if="!isActiveArticles">
        ...
        >
          <div
            ...
            :key="index"
            class="shadow-lg max-w-[450px] flex md:flex-row flex-col justify-between gap-3 px-5 py-8 rounded-lg relative border-2 bg-white border-[#2B8EFD] min-h-64"
          >
            <div
              class="bg-cover md:w-1/3 min-h-28 rounded bg-[url('https://www.popoptiq.com/wp-content/uploads/2018/08/articles-lead-image-082418-min.jpg')]"
            ></div>
            <div class="md:w-2/3 justify-between h-full gap-4 flex flex-col">
              <a
                ...
                >{{ evidence.source }}</a
              >
              <p class="text-base font-medium line-clamp-5">
                {{ evidence.info }}
              </p>
            </div>
